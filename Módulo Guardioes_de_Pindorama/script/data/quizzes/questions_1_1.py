...
class Questoes_1_1:
    ...
    perguntas = [
        ...
        },
        {
            ...
            "opcoes": [
                "Faixas Decorativas com formas geométricas, linhas e tramas em estamparia de roupas, em que as cores também são classificadas como um sistema de código e escrita.",
                ...
                "Pinturas Corporais, com hachuras, linhas e tramas, que utilizam pigmentos naturais extraídos de minérios e vegetais."
            ],
            "resposta_correta": "Pinturas Corporais, com hachuras, linhas e tramas, que utilizam pigmentos naturais extraídos de minérios e vegetais.",
            "pontos": 20
        },
        {
            "titulo": "Questão: Palavras do Espírito Ancestral",
            "pergunta": "Muitas palavras ainda ecoam a voz dos nossos ancestrais, mesmo quando poucos conhecem sua origem. Diga-me, quais destas palavras vêm das línguas originárias de nossa terra?",
            "opcoes": [
