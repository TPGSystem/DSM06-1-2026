...
class BossHudMatitaPereira(BossHudBase):
    """
    HUD específica da Matita Pereira.

    Regras:
    - vida 5 -> Hud_MatitaPereira_5.png
    - vida 4 -> Hud_MatitaPereira_4.png
    - vida 3 -> Hud_MatitaPereira_3.png
    - vida 2 -> Hud_MatitaPereira_2.png
    - vida 1 -> Hud_MatitaPereira_1.png
    - vida 0 -> Hud_MatitaPereira_0.png
    """

    DISPLAY_NAME = "MatitaPereira"
